  ...
  return (
    ...
    >
      ...
      >
        <iframe
          title="موقع المدرسة"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3380.123456789!2d35.065511!3d31.478368!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1502e53eb1aea2c9%3A0xb36007ee5ce98748!2z2LTYp9ix2Lkg2YXZiNin2K8g2YXYudin2YTZig!5e1!3m2!1sar!2s!4v1739304474062!5m2!1sar!2s"
          width="100%"
          height="480"
          loading="lazy"
          style={{ border: 0 }}
...
const contactSections = [
  {
    ...
    background: `linear-gradient(145deg, ${alpha("#36a336", 0.05)} 0%, ${alpha(
      "#36a336",
      0
    )} 100%)`,
    items: [
      { icon: <Person fontSize="small"/>, text: "إدارة: أسعد ابو زنيد" },
      { icon: <Phone fontSize="small"/>, text: "0569666617" },
      { icon: <Phone fontSize="small"/>, text: "0568099911" },
      { icon: <Phone fontSize="small"/>, text: "0599257637" },
      { icon: <LocationOn />, text: "الخليل دورا مخيم الفوار" },
    ],
    social: true,
    socialLinks: [
      { icon: <WhatsApp />, href: "https://wa.me/+972568099911" },
      {
        icon: <Facebook />,
  ...
  },
  {
    ...
    items: [
      { icon: <Person />, text: "أحمد العرجه" },
      { icon: <Email />, text: "arjaahmad782@gmail.com" },
      { icon: <Code />, text: "مطور تطبيقات لجميع المنصات" },
    ],
    social: true,
    socialLinks: [
      { icon: <WhatsApp />, href: "https://wa.me/+972594262092" },
      { icon: <LinkedIn />, href: "https://www.linkedin.com/in/ahmad-arja/" },
    ],
  },
];
